...
export const ShadowButton: React.FC<ShadowButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-[#FF7A00] text-shadow-black hover:bg-[#FF8A1F] hover:shadow-[0_0_20px_rgba(255,122,0,0.4)]",
    secondary: "bg-transparent border border-shadow-gray-700 text-shadow-300 hover:border-[#FF7A00] hover:text-[#FF7A00]",
